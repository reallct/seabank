...
public class ExceptionAdvice {
    ...
    * 一般失败处理
    * @params  [e]
    * @return: org.springframework.http.ResponseEntity<com.reallct.seabank.controller.req.CommonResponse<?>>
    * @Author: ahuang
...
//		e.printStackTrace();
    ...
    * 校验失败处理
    * @params  [e]
    * @return: com.reallct.seabank.controller.req.CommonResponse<?>
    * @Author: ahuang
    * @Date: 2018/7/7 下午10:15
    */
